...
public class ClassUtils {
	 ...
	 * @return
	 */
	public static Map<String, Class> scanPackage(String packageName, ClassFilter classFilter) {
		...
		for (String classPath : getClassPathArray()) {
			...
			fillClasses(new File(classPath), getWellFormedPackageName(packageName), classFilter, mapping);
		}
		return mapping;
	}
	 ...
	 * @return
	 */
	public static Map<String, Class> scanPackage(String packageName) {
	 ...
	 * @param classFilter
	 */
	private static void fillClass(String className, String packageName, Map<String, Class> mapping,
...
//			    System.out.println(clazz.getName());
				...
				if (checkClassFilter(classFilter, clazz)) {
						...
						if(annotation!=null){
						  mapping.put(annotation.url(), clazz);
						}
